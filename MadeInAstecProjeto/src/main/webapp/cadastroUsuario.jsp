                        ...
                        <c:choose>
                            <c:when test = "${empty Altera}">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="nomeUsu" onkeydown="javascript: fMasc(this, soLetras);"/>
                                </div>
                            ...
                            <c:otherwise>
                                <div class="form-group">
                                    <label for="nome">Nome*</label>
                                    <input type="text" class="form-control" name="nomeUsuario" value="${usu.getNome()}" id="nomeUsu" onkeydown="javascript: fMasc(this, soLetras);"/>
                                </div>
